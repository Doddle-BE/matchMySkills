    ...
    <header className="text-gray-900 dark:text-white">
      <div className="relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-b from-indigo-600/10 dark:from-indigo-600/30 to-transparent" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto backdrop-blur-sm py-2">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -inset-[10px] opacity-50">
            <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-indigo-400 rounded-full animate-float" />
            <div className="absolute top-3/4 left-2/3 w-2 h-2 bg-purple-400 rounded-full animate-float-delayed" />
            <div className="absolute top-1/2 left-1/3 w-2 h-2 bg-blue-400 rounded-full animate-float-slow" />
          </div>
        </div>
      </div>
    </header>
